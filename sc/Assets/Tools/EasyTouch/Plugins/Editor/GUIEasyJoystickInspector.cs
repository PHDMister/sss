...
{
    private GUIStyle _paddingStyle1;
    GUIStyle paddingStyle1
    {
        get
        {
            if (_paddingStyle1 == null)
            {
                _paddingStyle1 = new GUIStyle();
                _paddingStyle1.padding = new RectOffset(15,0,0,0);
            }
            return _paddingStyle1;
        }
    }
	...
	public override void OnInspectorGUI(){
		...
		if (t.showPosition){
            ...
            t.CustomRadius =  EditorGUILayout.FloatField("custom radius",t.CustomRadius);
            t.CustomOffset = EditorGUILayout.Vector2Field("custom offset", t.CustomOffset);
        }
		...
		if (t.showAppearance){
			...
			if (t.showZone){ 
				...
				t.CustomTexture = (Texture)EditorGUILayout.ObjectField("Cus texture",t.CustomTexture,typeof(Texture),true);
			}
			EditorGUILayout.Separator();
