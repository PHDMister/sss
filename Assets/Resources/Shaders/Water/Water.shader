Shader "URP/Water"
{
    ...
    {
        [Space(10)]
        [Main(Base, _, off, off)] _Base ("基础属性", Float) = 0
        [Space(10)]
...
//        
        [Space(10)]
        [Main(LargeNormal, _, off, off)] _LargeNormal ("大波纹法线", Float) = 0
        [Space(10)]
        ...
        [Space(10)]
        [Main(Fresnel, _, off, off)] _Fresnel ("Fresnel效应", Float) = 0
        [Space(10)]
...
//		[Sub(Splakes)]_SparklesAmount("数量", Range( 0 , 1)) = 0.09
        ...
        [Space(10)]
        [Main(Under, _, off, off)] _Under ("水底", Float) = 0
        [Space(10)]
...
//        [Sub(Reflect)]_ReflectDistort("扭曲", Range( 0 , 1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
          ...
          // #pragma renderers glcore gles gles3
           ...
           Varyings LitPassVertex(Attributes input)
            ...
            float4 LitPassFragment (Varyings input) : SV_Target
            {
				...
				//--bulid
            	//#else
            		//half screenDepth1 = SAMPLE_TEXTURE2D_X(_CameraDepthTexture, sampler_CameraDepthTexture,UnityStereoTransformScreenSpaceTex(screenPos.xy)).r ;
            		//half screenDepth = remapDepth(screenDepth1,0,1,-1,1);
                ...
                float foamMask = step(0,LinearEyeDepth(screenDepth,_ZBufferParams  ) - cszDepth);
               ...
               // half4 screenColor = LOAD_TEXTURE2D_X(_CameraOpaqueTexture, distortUV);
            	...
            	half3 combineColor = (waterColor).rgb * _DayIntensity;
