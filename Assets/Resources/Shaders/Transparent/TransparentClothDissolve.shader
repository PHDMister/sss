Shader "URP/Transparent/ClothDissolve"
{
    Properties
    {
        [Space(10)]
        ...
        Pass
        {
           ...
           #include "Assets/Resources/Shaders/PBR/LightingCustom.hlsl"
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                half BaseAlpha = clamp(_BaseColor.a * _Alpha * BaseColorAlpha.a * dissolve,0.0,1.0);
                half4 color = half4(lerp(0,0.3,DirectLighting) +lerp(0,0.7,IndirectLighting)  +edgeColor,BaseAlpha);
