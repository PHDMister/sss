...
public class GuidePanel : BaseUIForm
{
    ...
    public void OnClickLeftArrow()
    {
        ...
        if (m_CurCenterIdx <= 0)
            m_CurCenterIdx = 0;
        m_ScrollRectCenter.MoveScrollRectByIndex(m_CurCenterIdx);
        SetPointState(m_CurCenterIdx);
    }
    ...
    public void SetBtnState(int second)
    {
        if (second > 0)
        {
            ...
            m_BtnConfirm.GetComponent<Image>().material = grayMate;
            //m_TxtBtn.material = grayMate;
        ...
        else
        {
            ...
            m_BtnConfirm.GetComponent<Image>().material = defaultMate;
            //m_TxtBtn.material = defaultMate;

            m_BtnConfirm.interactable = true;
