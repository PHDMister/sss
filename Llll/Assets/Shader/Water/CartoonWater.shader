...
Shader "URP/Water/CartoonWater_Interactive"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 objectToClip7_g9 = TransformObjectToHClip(( IN.ase_texcoord3.xyz + vertexToFrag739 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 objectToClip7_g9 = TransformObjectToHClip(( IN.ase_texcoord2.xyz + vertexToFrag739 ));
				float3 objectToClip7_g9NDC = objectToClip7_g9.xyz/objectToClip7_g9.w;
				float4 appendResult13_g9 = (float4(objectToClip7_g9NDC , 1.0));
				float4 computeScreenPos10_g9 = ComputeScreenPos( appendResult13_g9 );
				float4 ScreenPos741 = computeScreenPos10_g9;
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				float3 vertexToFrag739 = WaveVertexPos194;
				o.ase_texcoord2.xyz = vertexToFrag739;
				float3 ase_worldTangent = TransformObjectToWorldDir(v.ase_tangent.xyz);
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 vertexToFrag739 = IN.ase_texcoord2.xyz;
				float4 objectToClip7_g9 = TransformObjectToHClip(( IN.ase_texcoord1.xyz + vertexToFrag739 ));
				float3 objectToClip7_g9NDC = objectToClip7_g9.xyz/objectToClip7_g9.w;
				float4 appendResult13_g9 = (float4(objectToClip7_g9NDC , 1.0));
				float4 computeScreenPos10_g9 = ComputeScreenPos( appendResult13_g9 );
				float4 ScreenPos741 = computeScreenPos10_g9;
...
/*ASEBEGIN
Version=18935
827.3334;174.6667;1527.333;1079;3796.862;-3033.285;3.861923;True;True
...
Node;AmplifyShaderEditor.StaticSwitch;631;-4564.547,3698.371;Inherit;False;Property;_WaterQuliaty1;水动画质量;15;0;Create;False;0;0;0;False;0;False;0;2;2;True;;KeywordEnum;3;LOW;MID;HIGH;Reference;630;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;630;-4606.198,2445.288;Inherit;False;Property;_WaterQuliaty;水动画质量;15;0;Create;False;0;0;0;False;2;Header((Water Normal));Space(5);False;0;2;2;True;;KeywordEnum;3;LOW;MID;HIGH;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;607;-172.9509,5819.234;Inherit;False;Property;_VERTEXWAVE;顶点波纹动画;48;0;Create;False;0;0;0;False;2;Header((Wave));Space(5);False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;624;-426.6443,-321.5014;Inherit;False;Property;_UNDERWATER2;水底;32;0;Create;False;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Reference;614;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;618;1692.413,1890.945;Inherit;False;Property;_Caustics;焦散动画;27;0;Create;False;0;0;0;False;2;Header((Caustics));Space(5);False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;614;76.59351,3476.401;Inherit;False;Property;_FOAM;岸边泡沫;32;0;Create;False;0;0;0;False;2;Header((Foam));Space(5);False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;622;-451.6099,-149.51;Inherit;False;Property;_UNDERWATER1;水底;8;0;Create;False;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Reference;620;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;738;-1387.278,1811.7;Inherit;False;Property;_DistortFix;扭曲修正;0;0;Create;False;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.StaticSwitch;615;71.92981,3969.873;Inherit;False;Property;_FOAM1;岸边泡沫;32;0;Create;False;0;0;0;False;2;Header((Foam));Space(5);False;0;0;0;True;;Toggle;2;Key0;Key1;Reference;614;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;620;-510.697,1883.61;Inherit;False;Property;_UNDERWATER;水底图;8;0;Create;False;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=90CFEFE8D34509DF74FBF43EE3A56880CAE401BB