...
public class RainbowBeachWelfare : BaseUIForm
{
    ...
    private Button btn_ranklist;
    private Button btn_rankend;
    ...
    private void Awake()
    {
        ...
        btn_ranklist = FindComp<Button>("raw_bg/btn_ranklist");
        btn_rankend = FindComp<Button>("raw_bg/btn_rankend");
    ...
    private void AddEvent()
    {
        ...
        RigisterCompEvent(btn_ranklist, Onbtn_ranklistClicked);
        RigisterCompEvent(btn_rankend, Onbtn_rankendClicked);
    ...
    private void Onbtn_ranklistClicked(GameObject go)
    {
        OpenUIForm(FormConst.RAINBOWRANKLIST);
    }
    private void Onbtn_rankendClicked(GameObject go)
    {
        OpenUIForm(FormConst.RAINBOWRANKLIST);
    }
    // UI EVENT FUNC END
    ...
    public override void Display()
    {
        ...
        btn_ranklist.gameObject.SetActive(resp.IsStart);
        btn_rankend.gameObject.SetActive(resp.IsStart == false);
    }

    public override void Hiding()
    {
        base.Hiding();
        RemoveBlackData("WelfareInfoResp1");
        Singleton<RainbowBeachDataModel>.Instance.ClearHeadCache();
    }
