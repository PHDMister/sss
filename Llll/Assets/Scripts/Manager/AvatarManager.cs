...
public class AvatarManager : MonoBehaviour
{
    ...
    public Dictionary<ulong, OtherPlayerAvatarData> AllOtherPlayerAvatarData = new Dictionary<ulong, OtherPlayerAvatarData>();
    ...
    public void SaveOutfitAvatarIDFun()
    {
        ...
        foreach (var keypair in PlayerAvatarModelDic)
        {
            var type2 = keypair.Key;
            if (!UIAvatarModelDic.ContainsKey(type2))
            {
                list.Add(type2);
            }
        }
        ...
        {
            RemoveAvatarModelFun(type2, true);
        }
...
*/
    ...
    /// 移除衣服模型
    /// </summary>
    public void RemoveAvatarModelFun(int avatar_type2, bool isRealControPlayer = false)
    {
        if (isRealControPlayer)
        {
            //判断身上是否有此类着装
    ...
    /// </summary>
    /// <param name="id"></param>
    public void RemoveAvatarTempDataFun(int id)
    {
        for (int i = 0; i < myOutFitAvatarIdData_tem.data.Count; i++)
        {
