...
public class RoomItem : BaseUIForm
{
    ...
    void Awake()
    {
        ...
        fullText = m_FullTrans.GetComponent<Text>();
    }
    ...
    public void SetFullState(bool bFull)
    {
        ...
        fullText.text = bFull ? GetFullText() : GetCurText();
        fullText.color = bFull ? new Color(252 / 255f, 75 / 255f, 75 / 255f) : new Color(49 / 255f, 157 / 255f, 79 / 255f);
    ...
    public void SetSelfRoomState(bool bSelf)
    {
        ...
        if (bSelf)
        {
            fullText.text = GetCurText();
            curText.text = GetCurText();
        }
        if (bSelf)
        {
