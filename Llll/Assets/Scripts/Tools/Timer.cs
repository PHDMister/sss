    ...
    public class Timer
    {
            ...
            bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
        {
            ...
            if (Timer._manager == null)
            {
                ...
                Timer._manager = managerObject.AddComponent<UnityTimer.TimerManager>();
        ...
        public static Timer RegisterRealTimeNoLoop(float duration, Action onComplete, Action<float> onUpdate = null, MonoBehaviour autoDestroyOwner = null)
        {
            return Register(duration, onComplete, onUpdate, false, true, autoDestroyOwner);
        }
        /// <summary>
