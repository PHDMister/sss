...
namespace UnityEngine
{
    ...
    {
        /// <summary>
        /// Draw a circular arc in 3D space. »­Ô²»¡
        /// </summary>
        ...
        /// <summary>
        /// Draw a circular sector (pie piece) in 3D space.  »­ÉÈÐÎ
        /// </summary>
        /// <param name="center">The center of the circle.</param>
        /// <param name="normal">The normal of the circle.</param>
        /// <param name="from">The direction of the point on the circle circumference, relative to the center, where the arc begins.</param>
        ...
        /// <summary>
        /// Draw the outline of a flat disc in 3D space. »­¿ÕÐÄÔ²
        /// </summary>
        ...
        /// <summary>
        /// Draw a solid flat disc in 3D space.  »­ÊµÐÄÔ²
        ...
        /// <summary>
        /// Make a text label positioned in 3D space. »­3dµÄ±êÇ©
        /// </summary>
