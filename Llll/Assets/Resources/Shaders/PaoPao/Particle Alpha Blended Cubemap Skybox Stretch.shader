...
Shader "URP/VFX/Particles" {
	Properties {
		[HDR]_TintColor ("Tint Color", Color) = (0.16, 0.16, 0.16, 1)
		_MainTex ("Base (RGB) Mask (A)", 2D) = "white" {}
		_CubemapPow ("Cubemap Intensity", Range(0, 2)) = 0.7
		_Stretch ("Circular Stretch", Range(-10,10)) = -0.3
		_CubemapOffset ("Cubemap Offset", Range(-2, 2)) = -0.15
		_DLightPow ("Dir Light Power", Range(0,100)) = 0.5
