Shader "URP/Char/EyeDissolve"
{
    Properties
    {
        ...
        [Sub(Base)][MainColor] _BaseColor("眼球颜色", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                #endif
                //half3 BaseColor = smoothstep(1,0,BaseColorAlpha) * _BaseColor.rgb + BaseColorAlpha.rgb;
                half3 BaseColor =clamp( ((BaseColorAlpha.a) * _BaseColor.rgb + BaseColorAlpha.rgb) - BaseColorAlpha.a * 0.8,0,1);
